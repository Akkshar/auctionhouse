...
if(input == '!game_shop'):
    ...
    print("Devices - can be used and sold")
    print("xp_cookie = 10000 \n Use this to get an exp multiplier\n")
    print("energy_boost = 25000 \n Use this to get your tasks done faster\n")
